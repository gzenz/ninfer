...
// cumulative counters, HTTP admission depth, memory layout, and load
// provenance. The formatter is a pure function (no I/O, no clock) so it is
// unit-testable; the HTTP handler fills timestamp_unix_ms and the live fields
// before calling it.
