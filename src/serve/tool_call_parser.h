...
// param_types is the schema-aware deserialization allow-list (above): only
// parameters whose declared type is a valid non-string type are deserialized
// from JSON-looking text; string-typed, unknown, and absent params preserve raw.
