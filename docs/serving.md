...
| `GET /stats` | read-only operational snapshot: scheduler occupancy, cumulative counters, HTTP admission depth, live paged-KV + host-KV occupancy, memory layout, and load provenance |
